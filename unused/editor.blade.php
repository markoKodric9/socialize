...
@section('title') Dashboard - Editor @endsection
...
<article class="content item-editor-page edit-content">
    <div class="title-search-block">
        <div class="title-block">
            <h3 class="title"> <span class="title-text">Project editor</span>
                <span class="title-description project-file"> Project: Hello World </span>
                <span class="title-description"> Current file: app.js </span>
                <span class="title-description"> File size: 6.4 KB </span>
                <span class="sparkline bar" data-type="bar"></span>
                
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-secondary"><i class="fa fa-code fa-fw"></i> Source</button>
                    <button type="button" class="btn btn-secondary"><i class="fa fa-pencil fa-fw"></i> Design</button>
                    <button type="button" class="btn btn-secondary"><i class="fa fa-desktop fa-fw"></i> Output</button>
                    <a href="new-project" class="btn btn-success btn-md rounded-s pull-right"><i class="fa fa-floppy-o fa-fw"></i>  Save</a>
                </div>
            </h3>
        </div>
    </div>

    <div class="col-sm-3 explorer-container">
        <div id="explorer-title">
            Explorer
        </div>
        <div id="file-explorer">
            <ul class="expl-structure">
            <li class="root">
            <img src="{{ asset('images/root.png') }}" width="16" height="16"/> app 
        </li>
        <li class="folder">
            <span class="folder-click"><img src="{{ asset('images/folder.png') }}" width="16" height="16"/> css</span>
            <ul class="sub">
                <li class="sub-file"><img src="{{ asset('images/css.png') }}" width="16" height="16"/> <a href="#">animate.min.css</a></li>
                <li class="sub-file"><img src="{{ asset('images/css.png') }}" width="16" height="16"/> <a href="#">grid-style.css</a></li>
                <li class="sub-file"><img src="{{ asset('images/css.png') }}" width="16" height="16"/> <a href="#">font-awesome.min.css</a></li>
                <li class="sub-file"><img src="{{ asset('images/css.png') }}" width="16" height="16"/> <a href="#">swiper.min.css</a></li>
            </ul>  
        </li>
        <li class="folder"><span class="folder-click"><img src="{{ asset('images/folder.png') }}" width="16" height="16"/> images</span></li>
        <li class="folder">
        <span class="folder-click"><img src="{{ asset('images/folder.png') }}" width="16" height="16"/> js</span>
            <ul class="sub">
                <li class="sub-file"><img src="{{ asset('images/js.png') }}" width="16" height="16"/> <a href="#">jquery.min.js</a></li>
                <li class="sub-file"><img src="{{ asset('images/js.png') }}" width="16" height="16"/> <a href="#">swiper.min.js</a></li>
            </ul>  
        </li>
        <li class="file"><img src="{{ asset('images/html.png') }}" width="16" height="16"/> <a href="#">index.html</a></li>
        
        <li class="special"><img src="{{ asset('images/git.png') }}" width="16" height="16"/> <a href="#">.gitignore</a></li>
            </ul>
        </div>
    </div>
    <div class="col-sm-9 edit-container">
        <div id="opened-files">
            <ul>
                <li class="active">app.js</li>
                <li>index.html</li>
                <li>grid-style.css</li>
                <li class="pull-right settings"><i class="fa fa-cogs fa-fw"></i></li>
            </ul>
        </div>
        <div id="editor">var config = window.config = {};
...
@section('custom-js')
    ...
    <script>
        $('.folder-click').on('click', function(e) {
            var a = e.target.parentNode.children[1];
            if($(a).hasClass("hidden-sub")){
                $(a).slideDown(200);
                $(a).removeClass("hidden-sub");
            } else {
                $(a).slideUp(200);
                $(a).addClass("hidden-sub");
            }
        });
    </script>
@endsection